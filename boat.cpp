...
#include<stdlib.h>
#include<stdio.h>
int m=0, h=0, f=0, b=0,start=0,w=0,qqq=0;
...
void display()
{
		...
		if (qqq == 1)
		{
			...
			drawhit("Kumar", 1250, 1100);
			drawhit("Adarsh.M.S", 1250, 900);
...
{
	printf("\t\t*****************  LOGICAL MOVE  ********************\n\n\n");
	//printf("Created By Kumar and Adarsh M S\n");
	printf("  Description:\n\n");
